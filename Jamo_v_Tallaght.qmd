...
plot_ly(Hospital_WaW, 
        ...
        mode = 'lines+markers',
        hovertemplate = paste(
          "<b>Hospital:</b> %{customdata[0]}<br>",
          "<b>Report Date:</b> %{x}<br>",
  ...
  layout(
    ...
    plot_bgcolor = 'rgba(255, 255, 255, 0.5)',  # Transparent background
    paper_bgcolor = 'rgba(255, 255, 255, 0.5)'  # Transparent paper
  )
