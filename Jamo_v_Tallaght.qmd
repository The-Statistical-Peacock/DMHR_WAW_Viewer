...
```{r}
#| title: Current WaW by Hospital (OPD)
...
```{r}
#| title: Current WaW by Speaciality (OPD)
...
```{r}
#| title: Current WaW by Hospital, Specialty (OPD)
...
```{r}
#| title: Current WaW by Hospital (IPDC)
...
```{r}
#| title: Current WaW by Speaciality (IPDC)
...
```{r}
#| title: Current WaW by Hospital, Specialty (IPDC)
